    ...
    <div className="order-list">
      ...
      <div className="list-header">
        <div>
          ...
          <p className="form-help">Orders created from inbound manufacturer documents.</p>
        </div>
        <button onClick={() => void fetchOrders()} className="refresh-btn">
          Refresh orders
        </button>
      </div>
                          ...
                          <tbody className="order-details-body">
                            {order.items.map((item) => (
                              <tr key={item.id}>
                                ...
                                <td className="line-item-price">PHP {item.unit_price?.toFixed(2)}</td>
                                <td className="line-item-total">PHP {item.line_total?.toFixed(2)}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
