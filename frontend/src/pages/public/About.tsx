...
const team = [
  { name: "Nicole Quimpan", role: "Team Leader", initials: "NQ", bio: "Leads the PhilHarvest team with a vision to connect Filipino farmers with buyers across the country." },
  { name: "Avril Matanguihan", role: "Member", initials: "AM", bio: "Contributes to platform development and ensures a seamless experience for farmers and buyers alike." },
  { name: "Adhonyz Dagle", role: "Member", initials: "AD", bio: "Supports the team in building and maintaining the PhilHarvest marketplace ecosystem." },
  { name: "Ayanna Lingahan", role: "Member", initials: "AL", bio: "Helps drive community engagement and ensures the platform meets the needs of Filipino farmers." },
  { name: "Dian Sharysse", role: "Member", initials: "DS", bio: "Dedicated to improving the user experience and expanding PhilHarvest's reach across the Philippines." },
  { name: "Iggy Quibo", role: "Member", initials: "IQ", bio: "Works on platform operations and supports the team in delivering fresh produce from farm to table." },
];
